...
public class Person2 {
    ...
    Deque<Person2> restroom = new ArrayDeque<>();
    Deque<Person2> isReady = new ArrayDeque<>();
    ...
    int maleCounter = 0;
    int femaleCounter = 0;
    Person2 test = new Person2(1,1,1);

    public Person2(int id, int gender, int time) {
        this.id = id;
        this.gender = gender;
        this.time = time;
    }
...
//    }
    ...
    public void BestArrivals(Deque<Person2> allPeople) {
        int personCounter = 0;
    ...
    public void UseFacilities(Deque<Person2> allPeople) {
        // males = 1
        // females = 0
    ...
    public void Departures(Deque<Person2> allPeople)
    {
        System.out.println();
        System.out.println("Departures");

        for(Person2 departed: restroom)
        {
            departure +=1;
    ...
    public void Allmethods(Deque<Person2> allPeople)
    {
